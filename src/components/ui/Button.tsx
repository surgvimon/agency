    ...
    { 
        variants: {
           variant: {
              ...
              "tertiary-color-booking": "bg-white border border-[#D1D4DA] text-[#0B4A6F] hover:bg-[#0BA5EC] hover:text-white hover:border-[#0BA5EC] active:bg-white active:border-[#D1D4DA] active:text-[#026AA2] disabled:bg-[#EAECF0] disabled:text-white disabled:border-[#EAECF0]",
